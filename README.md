...
[![Version](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/release/module.json&label=Current+Version&query=version&color=blue)](https://github.com/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/releases/latest)
[![Foundry Compatibility](https://img.shields.io/badge/dynamic/json.svg?url=https%3A%2F%2Fraw.githubusercontent.com%2FTeo-Lopez%2Ffvtt-wfrp4e-gmtoolkit%2Frelease%2Fmodule.json&label=Foundry%20VTT%20Version&query=$.compatibility.minimum&colorB=orange)](https://foundryvtt.com/releases/)
[![GitHub release](https://img.shields.io/github/release-date/Teo-Lopez/fvtt-wfrp4e-gmtoolkit?label=Released&color=brightgreen)](https://github.com/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/releases)
[![GitHub commits](https://img.shields.io/github/commits-since/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/latest?label=Commits%20Since%20Release&color=yellowgreen)](https://github.com/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/commits/)<br>
![the latest version zip](https://img.shields.io/github/downloads/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/latest/wfrp4e-gm-toolkit.zip?label=Downloads%20(Current%20Version)&color=blue)
![all downloads zip](https://img.shields.io/github/downloads/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/wfrp4e-gm-toolkit.zip?label=Total%20Downloads&color=blueviolet)

> **Fork notice:** This repository is a personal fork of [Jagusti/fvtt-wfrp4e-gmtoolkit](https://github.com/Jagusti/fvtt-wfrp4e-gmtoolkit) with **Foundry VTT v14** support. For the upstream v13 release line, use the original project.
...
- Foundry VTT: v14.360 (minimum v14)
- WFRP4e: 9.1.3
...
1. **Install the module** via the Add-on Modules tab of Foundry VTT setup.
   ...
   - Manifest URL: https://github.com/Teo-Lopez/fvtt-wfrp4e-gmtoolkit/releases/latest/download/module.json
